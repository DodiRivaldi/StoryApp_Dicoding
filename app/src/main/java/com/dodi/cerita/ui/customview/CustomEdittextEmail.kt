...
class CustomEdittextEmail : AppCompatEditText{
    ...
    private fun init(){
        drawable = ContextCompat.getDrawable(context,android.R.drawable.ic_dialog_email)as Drawable
        ...
        addTextChangedListener(object :TextWatcher{
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                error = if (!isValid && !p0.isNullOrEmpty()) context.getString(R.string.warning_email) else null
            }
