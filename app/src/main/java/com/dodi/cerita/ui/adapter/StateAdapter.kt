...
class StateAdapter (private val retry : ()->Unit) : LoadStateAdapter<StateAdapter.StateViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): StateViewHolder {
        val binding = ItemReloadAdapterBinding.inflate(LayoutInflater.from(parent.context),parent,false)
